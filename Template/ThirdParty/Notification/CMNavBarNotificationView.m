...
#define kCMNavBarNotificationHeight 64.0f
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(__imagePadding, __imagePadding, _contentView.frame.size.height-2*__imagePadding,  _contentView.frame.size.height-2*__imagePadding)];
        _imageView.contentMode = UIViewContentModeScaleAspectFill;
        _imageView.layer.cornerRadius = 4.0f;
        _imageView.clipsToBounds = YES;
        [self addSubview:_imageView];
        
        UIFont *textFont = [UIFont fontWithName:@"HelveticaNeue-Medium" size:14.0f];
        CGRect textFrame =CGRectMake(_imageView.frame.size.width+_imageView.frame.origin.x+__imagePadding, __imagePadding,
                                     (        _contentView.frame.size.width-(_imageView.frame.size.width+_imageView.frame.origin.x+2*__imagePadding)),
        ...
        CGRectMake(CGRectGetMinX(textFrame), CGRectGetMaxY(textFrame),
                   ...
                   _imageView.frame.size.height/2);
        
        _detailTextLabel = [[UILabel alloc] initWithFrame:textFrame];
        ...
        _detailTextLabel.minimumScaleFactor=0.5;
