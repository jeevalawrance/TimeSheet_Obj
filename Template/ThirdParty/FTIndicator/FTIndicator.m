...
+ (void)showNotificationWithImage:(UIImage *)image title:(NSString *)title message:(NSString *)message backgGroundProperty:(id)backgroundPropery
{
    [self showNotificationWithImage:image title:title message:message backgGroundProperty:backgroundPropery autoDismiss:YES tapHandler:nil completion:nil];
}
...
{
    [FTNotificationIndicator showNotificationWithImage:image title:title message:message backgroundProperty:nil autoDismiss:autoDismiss tapHandler:tapHandler completion:completion];
}
+ (void)showNotificationWithImage:(UIImage *)image title:(NSString *)title message:(NSString *)message backgGroundProperty:(id)backgroundPropery autoDismiss:(BOOL)autoDismiss tapHandler:(FTNotificationTapHandler)tapHandler completion:(FTNotificationCompletion)completion
{
    [FTNotificationIndicator showNotificationWithImage:image title:title message:message backgroundProperty:backgroundPropery autoDismiss:autoDismiss tapHandler:tapHandler completion:completion];
}
